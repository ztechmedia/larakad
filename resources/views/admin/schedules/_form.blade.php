...
<input type="text" value="{{ isset($schedule) ? $schedule->year : $year  }}" id="year" name="year" style="display:none">
<input type="text" value="{{ isset($schedule) ? $schedule->semester : $semester  }}" id="semester" name="semester" style="display:none">
